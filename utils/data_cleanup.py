'''
This data_cleanup.py script is adapted from
the original version available at:
https://github.com/Colorado-Mesa-University-Cybersecurity/

Modifications have been made for the purposes of this project.
'''
